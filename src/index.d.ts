...
declare namespace connect {
  ...
  */
  ...
  interface VoiceConnection extends BaseConnection {
    ...
    sendDigits(digits: string, options: SuccessFailOptions);
    hold(options: SuccessFailOptions);
    resume(options: SuccessFailOptions);
    isOnHold(): boolean;
  }
  ...
  interface ChatConnection extends BaseConnection {
    ...
    getMediaInfo(): any;
    getMediaController(): any;
    getConnectionToken(): Promise<{ chatTokenTransport: { participantToken: string } }>
  }

  type Connection = ChatConnection | VoiceConnection;
